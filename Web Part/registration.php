...
if(isset($_POST['registartion']))
{
  ...
  {
      echo "<script type='text/javascript'>alert('registration succsesfull!!!')</script>";
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="registration.php" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="registartion" onclick="myfunction()">Create Account</button>
                    </div>
                    <div class="col-12">
